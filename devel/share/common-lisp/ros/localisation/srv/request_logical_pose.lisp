...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<request_logical_pose-request>)))
  ...
  "ebb5db2f0e9731be90b45f89a16a5506")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'request_logical_pose-request)))
  "Returns md5sum for a message object of type 'request_logical_pose-request"
  "ebb5db2f0e9731be90b45f89a16a5506")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<request_logical_pose-response>)))
  ...
  (cl:format cl:nil "geometry_msgs/Vector3 position~%geometry_msgs/Quaternion orientation~%geometry_msgs/Quaternion tgtorientation~%geometry_msgs/Vector3 tgtposition~%bool order_completed~%~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'request_logical_pose-response)))
  "Returns full string definition for message of type 'request_logical_pose-response"
  (cl:format cl:nil "geometry_msgs/Vector3 position~%geometry_msgs/Quaternion orientation~%geometry_msgs/Quaternion tgtorientation~%geometry_msgs/Vector3 tgtposition~%bool order_completed~%~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
