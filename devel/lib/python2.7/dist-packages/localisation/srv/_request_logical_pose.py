...
class request_logical_poseResponse(genpy.Message):
  _md5sum = "75f228459811dec196bc25a1d29ce336"
...
float64 w
"""
  __slots__ = ['position','orientation','tgtorientation','tgtposition','order_completed']
  _slot_types = ['geometry_msgs/Vector3','geometry_msgs/Quaternion','geometry_msgs/Quaternion','geometry_msgs/Vector3','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       position,orientation,tgtorientation,tgtposition,order_completed
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_14dB.pack(_x.position.x, _x.position.y, _x.position.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.tgtorientation.x, _x.tgtorientation.y, _x.tgtorientation.z, _x.tgtorientation.w, _x.tgtposition.x, _x.tgtposition.y, _x.tgtposition.z, _x.order_completed))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position.x, _x.position.y, _x.position.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.tgtorientation.x, _x.tgtorientation.y, _x.tgtorientation.z, _x.tgtorientation.w, _x.tgtposition.x, _x.tgtposition.y, _x.tgtposition.z, _x.order_completed,) = _struct_14dB.unpack(str[start:end])
...
class request_logical_pose(object):
  ...
  _md5sum = 'ebb5db2f0e9731be90b45f89a16a5506'
